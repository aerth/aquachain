...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db aquadb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db aquadb.Database) error {
