...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (aqua/61) or header (aqua/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (aqua/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both aqua/61 and aqua/62)
}
